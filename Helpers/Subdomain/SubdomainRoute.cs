...
namespace Portal.Helpers
{
    public class SubdomainRoute : Route
    {
        ...
        public SubdomainRoute(string domain, string url, object defaults, object constraints, string[] namespaces)
            : base(url, new RouteValueDictionary(defaults),new RouteValueDictionary(constraints), new MvcRouteHandler())
        {
            ...
            {
                if (DataTokens == null) DataTokens = new RouteValueDictionary();
        ...
        public override RouteData GetRouteData(HttpContextBase httpContext)
        {
            ...
            if (domainMatch.Success && pathMatch.Success)
            {
                ...
                //if (DataTokens != null)
                //{
                //    foreach (KeyValuePair<string, object> item in DataTokens)
                //    {
                ...
                //        if (!string.IsNullOrEmpty(key) && !char.IsNumber(key, 0))
                //        {
                //            //TODO проверка соответствия constraints
                //            if (!string.IsNullOrEmpty(group.Value))
                //            {
                //                data.Values[key] = group.Value;
                //            }
